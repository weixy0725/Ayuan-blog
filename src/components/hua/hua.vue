<template>
<!--https://github.com/koibi2/vue_comment_components/blob/master/src/components/vue_comment/b_comment.vue-->
    ...
    export default {
        ...
        data() {
            return {
                ...
                maxwidth: 108, /*拖动最大宽度，依据滑块宽度算出来的  滑块宽度-42PX  */  //258-60
        ...
        methods: {
            ...
            successFunction() {
                ...
                //把文字宽度改为230px，让它居中
                this.$refs.drag_text.style.width = 120 + "px";
            ...
            reset_verify() {
                ...
                //把文字宽度改为260px，让它居中
                this.$refs.drag_text.style.width = "150px";
            },
            //绑定的滑块拖动事件。
            mouseMove_event(ev) {
                let e = ev || event;
